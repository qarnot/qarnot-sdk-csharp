...
namespace QarnotSDK {
    public partial class Connection {
        ...
        public List<QTask> RetrieveTasks(CancellationToken cancellationToken = new CancellationToken()) {
            try {
        ...
        public List<QPool> RetrievePools(CancellationToken cancellationToken = new CancellationToken()) {
            try {
        ...
        public List<QDisk> RetrieveDisks(CancellationToken cancellationToken = new CancellationToken()) {
            try {
        ...
        public UserInformation RetrieveUserInformation(CancellationToken cancellationToken = new CancellationToken()) {
            try {
        ...
        public List<string> RetrieveProfiles(CancellationToken cancellationToken = new CancellationToken()) {
            try {
        ...
        public List<Constant> RetrieveConstants(string profile, CancellationToken cancellationToken = new CancellationToken()) {
            try {
        ...
        public QTask RetrieveTaskByName(string name, CancellationToken cancellationToken = new CancellationToken()) {
            try {
        ...
        public QPool RetrievePoolByName(string name, CancellationToken cancellationToken = new CancellationToken()) {
            try {
        ...
        public QDisk RetrieveDiskByName(string name, CancellationToken cancellationToken = new CancellationToken()) {
            try {
